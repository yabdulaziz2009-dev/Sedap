...
const Header = () => {
  return (
    <header className="bg-[#f3f4f6] flex items-center justify-between px-8 py-4 sticky top-0 z-20">
      {/* Search Bar */}
      <div className="relative w-full max-w-md hidden md:block text-gray-400 bg-white rounded-xl">
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          <FiSearch className="text-gray-400" />
        </div>
        <input
          type="text"
          className="bg-transparent border-none text-gray-800 text-sm rounded-xl focus:ring-[#00B074] focus:border-[#00B074] block w-full pl-10 p-3 h-12"
      ...
      <div className="flex items-center gap-6 ml-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="p-3 rounded-xl bg-gray-200/60 text-gray-500 hover:bg-gray-300/60 transition-colors">
            <FiGift size={20} />
          </button>
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          <div className="text-right hidden sm:block">
            <p className="text-sm text-gray-500">Hello, <span className="font-semibold text-gray-800">Samantha</span></p>
          </div>
